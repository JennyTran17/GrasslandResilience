...
function getMapId() {
  ...
  // Valid for ~7 days
  const MAP_ID = 'f25685a294616a549253cb8bbcdbda43-4e185461bba1916b4db2ccab5da2cdee';

  console.log('[Precipitation Tiles] Using Map ID from Code Editor (generated 2025-11-18)');
